...
def main():
    ...
    vti_c = fetch_from_yahoo("VTI", "285.50", "+0.45%")
    vxus_c = fetch_from_yahoo("VXUS", "63.20", "-0.12%")
    vt_c = fetch_from_yahoo("VT", "112.80", "+0.22%")
    tw50_c = fetch_from_yahoo("0050.TW", "175.30", "+0.85%")
    tsmc_c = fetch_from_yahoo("2330.TW", "870.00", "+1.15%")
    honhai_c = fetch_from_yahoo("2317.TW", "172.00", "-0.58%")
    japan_c = fetch_from_yahoo("00981A.TW", "14.85", "+0.20%")
